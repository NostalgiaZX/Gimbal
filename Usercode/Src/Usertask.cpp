...
[[noreturn]] void gimbal(void *argument) {
    while (1)
    {
        ...
        yawmotor.SetPosition(yawangleset,0,yawinten);
        pitchmotor.friction_intensity=adjust_fintensity(pitchmotor.oneway_timesum);
        pitchmotor.SetPosition(pitchangleset,0,pitchforwardinten(pitchmotor.fdb_angle_));
        //pitchmotor.SetPosition(pitchangle,0,pitchforwardinten(pitchmotor.fdb_angle_)+pitchmotor.friction_intensity);
        //yawmotor.SetSpeed(yawspeed,yawinten);
        //pitchmotor.SetSpeed(pitchspeed,pitchinten);
        //pitchmotor.SetIntensity(pitchinten);
        yawmotor.Handle();
        pitchmotor.Handle();
